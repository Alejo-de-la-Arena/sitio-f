...
if($resultado!=0){
	...
	<?php
		...
		<a href='./form_registro.html'>Registrate</a>
...
<div class="contenido-exclusivo"> 
    <h2 class="panel-h2"> ¡Contenido Exclusivo! </h2>
    <div class="contenido-exclusivo-img">
        <img src="./img/img/museo.jpeg" alt="">
        <img src="./img/img/museo2.jpg" alt="">
        <img src="./img/img/MuseoSofia.jpg" alt="">
    </div>
</div>
